...
export default function App(){
  ...
  const issueCoins=(amount)=>{
    if(totalIssued+amount>MAX_ISSUED){
      ...
      if(!isGuest)setDoc(doc(db,"users",user.id),{coins:newCoins,totalIssued:MAX_ISSUED},{merge:true});
      return true;
    }
    ...
    if(!isGuest)setDoc(doc(db,"users",user.id),{coins:newCoins,totalIssued:newIssued},{merge:true});
    return true;
  };
