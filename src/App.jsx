...
const REAL_CARDS = {
  sar: [
    { name: "メガルカリオ ex", rarity: "SAR", img: "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card" },
  ],
  sr: [
    { name: "メガズルズキン ex", rarity: "SAR", img: "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card" },
    { name: "ルリナ", rarity: "SR", img: "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card" },
    { name: "サイトウ", rarity: "HR", img: "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card" },
    { name: "ビクティニ", rarity: "AR", img: "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card" },
    { name: "メガカイリュー ex", rarity: "MA", img: "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card" },
    { name: "ナンジャモのハラバリー ex", rarity: "UR", img: "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card" },
  ],
  lucario: "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card",
};
...
const BG_LUCARIO = "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card";

const IMG_1000COIN = "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card";
const IMG_KAKUMEI = "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card";

const INVITE_COIN = "https://via.placeholder.com/300x420/1a1a2a/ffffff?text=Card";
...
const checkMonthlyLimit = (cost, onPass) => {
  // 未確認なら年齢確認モーダルを出す
  if (!ageConfirmed) {
    setPendingPurchase(() => () => checkMonthlyLimit(cost, onPass));
  ...
  <div style={{ minHeight: "100vh", background: "#06060e", fontFamily: "'Noto Sans JP',sans-serif" }}>
    ...
    {multiReveal && <MultiReveal cards={multiReveal.cards} pack={multiReveal.pack}
      onClose={(remainCards) => {
        ...
        else setPendingCards(p => [...p, ...multiReveal.cards]);
        setMultiReveal(null);
      }}
